...
The function having the cross reference for ZwTerminateProcess is examined and found to take the ProcessID as an arguement to spot it and kill it as long as it is not a system(PID 4) process.<br>
![sub_152B0](./media/6.png)

The function was marked as `TerminateProcessByPID` and Cross References to it were listed. the function only gets called at one point in another function.<br>
